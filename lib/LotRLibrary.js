...
export default class LotRLibrary {
     ...
     * Non Auth calls are available only to get books of the trilogy.
     */
    ...
    */
    async getChaptersByName(name) {
        ...
        const route = `/chapter?chapterName=${name}`;
    ...
    */
    async getQuotesByCharacterName(name) {
        const characterObject = await this.getCharactersByName(name);
    ...
    /******START CHARACTERS*******/
    /**
     * Returns all the Lord of the Rings movie characters.
     */
    async getCharacters() {
        let config = {
            headers: {
    ...
    /**
    * Returns one of the Lord of the Rings movie character with the specified id
    ...
    */
    ...
    /**
    * Returns the Lord of the Rings characters with the specified names
    ...
    */
    ...
    /**
    * Returns the Lord of the Rings characters with the specified gender
    ...
    */
    ...
    /**
    * Returns the Lord of the Rings characters sorted by name (asc or desc)
    * @param sortType - the sort type - can be asc or desc
    */
